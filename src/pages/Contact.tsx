              ...
              <AnimateOnScroll animation="slide-right" className="order-2 lg:order-2">
                <div className="space-y-8">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <ul className="text-muted-foreground space-y-1 text-sm">
                          <li>Mo - Do: 8:30 - 19:00</li>
                          <li>Freitag: 8:30 - 20:00</li>
                          <li>Samstag: 8:30 - 18:00</li>
                  ...
                  <div className="aspect-video rounded-sm overflow-hidden border border-border mt-8">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d21203.97113317327!2d10.865551174316408!3d48.3702!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479ebd57b16dca05%3A0x31d9b719fff2c887!2sG%C3%B6zde%20Coiffeure%20Augsburg!5e0!3m2!1sde!2sde!4v1770573837589!5m2!1sde!2sde"
                      width="100%"
                      height="100%"
                      ...
                      title="Standort Samer Barbershop"
                    />
                  </div>
                </div>
              </AnimateOnScroll>
